"""Workload generator for TraceQuery benchmark."""
...
class WorkloadGenerator:
    ...
    Supports prefix reuse: a configurable ratio of queries share a common prefix
    with previous queries, simulating real-world conversational/multi-turn patterns.
    """
