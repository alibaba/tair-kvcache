...
public:
    ...
    KVCM_DECLARE_METRICS_COLLECTOR_MAP_METHOD_(GetBatchCacheLocations);
    KVCM_DECLARE_METRICS_COLLECTOR_MAP_METHOD_(GetCacheLocationLen);
    KVCM_DECLARE_METRICS_COLLECTOR_MAP_METHOD_(StartWriteCache);
    KVCM_DECLARE_METRICS_COLLECTOR_MAP_METHOD_(StartEvictWriteCache);
