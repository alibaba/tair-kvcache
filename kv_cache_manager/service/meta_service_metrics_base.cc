...
void MetaServiceMetricsBase::InitMetrics() {
    ...
    MAKE_SERVICE_METRICS_COLLECTOR(StartEvictWriteCache);
...
KVCM_DEFINE_METRICS_COLLECTOR_MAP_METHOD_(GetBatchCacheLocations);
KVCM_DEFINE_METRICS_COLLECTOR_MAP_METHOD_(GetCacheLocationLen);
KVCM_DEFINE_METRICS_COLLECTOR_MAP_METHOD_(StartWriteCache);
KVCM_DEFINE_METRICS_COLLECTOR_MAP_METHOD_(StartEvictWriteCache);
