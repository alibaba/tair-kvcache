...
TEST_F(StorageConfigTest, TestEventReportStorageSpecJsonRoundTripIncludesSnapshotInterval) {
...
TEST_F(StorageConfigTest, TestEventReportStorageSpecSnapshotIntervalDefaultAndValidation) {
