...
// CA_CRC32_XOR_INT64 is what SdkBufferCheckUtil::GetBlocksHash produces (CRC32 over
// each iov's configured head/tail sample, aggregated via HashUtil::HashIntArray).
