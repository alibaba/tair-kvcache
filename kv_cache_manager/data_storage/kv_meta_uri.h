...
inline bool
TryGetTairMempoolUint16Param(const DataStorageUri &uri, const std::string &name, std::uint16_t &value, bool required) {
    value = 0;
...
inline constexpr bool IsKvMetaTairMempoolMediaCompatible(std::uint16_t configured, std::uint16_t actual) noexcept {
