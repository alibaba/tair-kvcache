...
grpc::Status OptimizerServiceGRpc::CreateInstanceGroup(
...
grpc::Status OptimizerServiceGRpc::UpdateInstanceGroup(
    grpc::ServerContext *context,
...
grpc::Status OptimizerServiceGRpc::RemoveInstanceGroup(
    grpc::ServerContext *context,
...
grpc::Status OptimizerServiceGRpc::GetInstanceGroup(
    grpc::ServerContext *context,
...
grpc::Status OptimizerServiceGRpc::ListInstanceGroups(
    grpc::ServerContext *context,
...
grpc::Status OptimizerServiceGRpc::RegisterInstance(
    grpc::ServerContext *context,
...
grpc::Status OptimizerServiceGRpc::RemoveInstance(
    grpc::ServerContext *context,
...
grpc::Status OptimizerServiceGRpc::ListInstances(
    grpc::ServerContext *context,
...
grpc::Status OptimizerServiceGRpc::ResetStats(
    grpc::ServerContext *context,
