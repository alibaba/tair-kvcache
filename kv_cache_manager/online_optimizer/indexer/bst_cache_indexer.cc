...
int64_t AugmentedTreap::GetSize(TreapNode *node) { return node ? node->size : 0; }
...
int64_t AugmentedTreap::Size() const { return GetSize(root_); }
...
int64_t BSTCacheIndexer::kv_cache_usage_bytes() const { return unique_count() * avg_bytes_per_block_; }
...
int64_t BSTCacheIndexer::unique_count() const { return treap_.Size(); }

void BSTCacheIndexer::PostQueryMaintenance() { EvictIfExceedsCapacity(); }
