...
public:
    ...
    OptimizerInstanceInfo(const std::string &instance_group_name,
        ...
        , full_group_name_(full_group_name) {}
    ...
    const std::string &full_group_name() const { return full_group_name_; }
    ...
    void set_full_group_name(const std::string &v) { full_group_name_ = v; }
